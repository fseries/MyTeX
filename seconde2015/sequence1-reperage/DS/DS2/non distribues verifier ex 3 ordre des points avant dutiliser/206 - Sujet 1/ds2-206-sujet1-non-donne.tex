...
%\clip (X) rectangle (Y);
%\placerpoint{A}{-4}{1}{below left};
\placerpoint{B}{5}{3}{above right};
\placerpoint{C}{0}{4}{below right};
\placerpoint{D}{9}{6}{above left};
...
On se place dans le repère~\emph{orthonormé}\rep{O}{I}{J}. Dans ce repère, on considère les points $\pointcoord{R}{-2}{0}$, $\pointcoord{S}{0}{2}$ et $\pointcoord{T}{7}{-7}$.\\Vos réponses seront argumentées.
