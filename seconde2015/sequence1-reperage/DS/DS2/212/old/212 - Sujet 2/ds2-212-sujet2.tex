...
%\clip (X) rectangle (Y);
%\placerpoint{A}{-6}{-1}{below left};
\placerpoint{B}{-2}{2}{above left};
\placerpoint{C}{7}{4}{above left};
\placerpoint{D}{3}{1}{above right};
...
On se place dans le repère~\emph{orthonormé}\rep{O}{I}{J}. Dans ce repère, on considère les points $\pointcoord{R}{-2}{2}$, $\pointcoord{S}{2}{-2}$, $\pointcoord{T}{5}{5}$ et $\pointcoord{U}{6}{7}$.\\Vos réponses seront argumentées.
...
Le plan $\left(\mathscr{P}\right)$ est muni d'un repère~\emph{orthonormé}\rep{O}{I}{J}.\\ Dans ce repère, on considère les points suivants $\pointcoord{A}{-10}{-2}$ ; $\pointcoord{B}{-2}{4}$, $\pointcoord{C}{4}{12}$ et  $\pointcoord{D}{-4}{6}$.
