...
\fancypagestyle{firststyle}
{
	...
	\fancyhf{}
	\lhead[]{\textbf{Mathématiques\\DS2 -- Sujet 1}}
	\chead[]{Seconde 12\\ lundi 12 octobre 2015}
...
%\clip (X) rectangle (Y);
%\placerpoint{A}{-8}{1}{below left};
\placerpoint{B}{5}{6}{above left};
\placerpoint{C}{-4}{4}{below right};
\placerpoint{D}{1}{3}{above right};
...
On se place dans le repère~\emph{orthonormé}\rep{O}{I}{J}. Dans ce repère, on considère les points $\pointcoord{R}{-2}{2}$, $\pointcoord{S}{2}{-2}$, $\pointcoord{T}{6}{7}$ et $\pointcoord{U}{5}{5}$.\\Vos réponses seront argumentées.
...
Le plan $\left(\mathscr{P}\right)$ est muni d'un repère~\emph{orthonormé}\rep{O}{I}{J}.\\ Dans ce repère, on considère les points suivants $\pointcoord{A}{-6}{2}$ ; $\pointcoord{B}{2}{8}$, $\pointcoord{C}{8}{16}$ et $\pointcoord{D}{0}{10}$.
