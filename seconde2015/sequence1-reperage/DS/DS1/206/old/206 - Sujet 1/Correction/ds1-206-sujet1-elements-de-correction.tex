...
\fancypagestyle{firststyle}
{
	...
	\fancyhf{}
	\lhead[]{\textbf{Mathématiques\\DS1 -- éléments de correction}}
...
\begin{enumerate}
	...
	\item Dans le repère\rep{O}{I}{J},\\[1em]
			...
			Donc \fbox{$\pointcoord{D}{-47}{-73}$}\\[1em]
			De même, on a~:\\[1em] \fbox{$\pointcoord{E}{-22}{2}$} et \fbox{$\pointcoord{F}{-97}{27}$}
\end{enumerate}
